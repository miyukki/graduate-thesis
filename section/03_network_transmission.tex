...
被験者の対象は、映像制作現場に関わったことがある人で、マルチビュー映像に理解がある人と限定した。実験データの母数は34人である。
...
133.33msでは9割以上、166.66msになった瞬間に、8割を下回る。
また、急激に　233.33ms 266.66msになった2割

133.33msすなわち30FPSでは4フレーム、60FPSでは8フレームであれば、映像制作現場において9割以上が遅延を許容できると言える。
