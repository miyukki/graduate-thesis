...
インターレースではない、画像をプログレッシブと呼び、インターレースからプログレッシブに変換する処理を、デインターレースと呼ぶ。
% 一時停止をした際に、動きの激しい箇所が
...
\subsection{DVI}
DVI（Digital Visual Interface）は、VESA\footnote{Video Electronics Standards Association ビデオ周辺機器に関する業界標準化団体}によって標準化された デジタル映像信号の伝送規格。
...
また、CES 2017に合わせ、HDMI 2.1が発表され、帯域を48Gbpsまでサポートし、8K@60pに対応した。
% また、HDMI 2.0
% 1.4 / 2.0
